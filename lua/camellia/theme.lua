...
function M.get(config)
    local p = require('camellia.palette')
    ...
    theme = {
        ...
        DiffAdd = { fg = p.color5, bg = background },
        DiffChange = { fg = p.color4, bg = background },
        DiffDelete = { fg = p.color2, bg = background },
        DiffText = { fg = p.color3, bg = background },
        Directory = { fg = p.color4 },
        EndOfBuffer = { fg = p.color1 },
        ...
        Function = { fg = p.color4 },
        Identifier = { fg = p.color4 },
        Ignore = { fg = p.color7, bg = background },
        IncSearch = { fg = p.color1, bg = p.color10 },
        Include = { fg = p.color3 },
        Keyword = { fg = p.color3 },
        Label = { fg = p.color4 },
        ...
        PmenuSel = { fg = p.color1, bg = p.color4 },
        ...
        Repeat = { fg = p.color6 },
        Search = { fg = p.color1, bg = p.color10 },
        SignColumn = { fg = p.color1, bg = background },
        Special = { fg = p.color6 },
        ...
        StatusLineNC = { bg = background, fg = p.color1 },
        Storage = { fg = p.color9 },
        ...
        Todo = { fg = p.color12, bg = background },
        Type = { fg = p.color2 },
        Typedef = { fg = p.color15 },
        Underlined = { fg = p.color3 },
        Variable = { fg = p.color7 },
        VertSplit = { fg = p.color1, bg = p.color0 },
        ...
        BufferLineFill = { fg = p.color1, bg = background },
        BufferLineIndicatorSelected = { fg = p.color2 },

        -- Diagnostic
        DiagnosticError = { fg = p.color2 },
        DiagnosticHint = { fg = p.color13 },
        ...
        LspSagaFinderSelection = { fg = p.color3 },
        ...
        NeogitDiffDeleteHighlight = { fg = p.color3, bg = background },
        NeogitHunkHeader = { bg = background, fg = p.foreground },
        NeogitHunkHeaderHighlight = { bg = p.comment, fg = p.color7 },
        NeogitRemote = { fg = p.color6 },

        -- Neovim
        healthError = { fg = p.color2 },
        healthSuccess = { fg = p.color5 },
        healthWarning = { fg = p.color4 },
        ...
        NvimTreeFolderIcon = { fg = p.color7, bg = background },
        NvimTreeFolderName = { fg = p.foreground },
        NvimTreeGitDeleted = { fg = p.comment },
        NvimTreeGitDirty = { fg = p.color7 },
        ...
        NvimTreeOpenedFolderName = { fg = p.color7 },
        NvimTreeRootFolder = { fg = p.comment },
        NvimTreeSpecialFile = { fg = p.color6 },
        NvimTreeStatusLineNC = { bg = background, fg = p.color1 },
        ...
        ["@field"] = { fg = p.color2 },
        ["@float"] = { fg = p.color8 },
        ["@function"] = { fg = p.color2 },
        ["@function.builtin"] = { fg = p.color2 },
        ...
        ["@text.underline"] = { fg = p.color3, underline = true },
        ["@text.uri"] = { fg = p.color3, underline = true },
        ["@text.warning"] = { fg = p.color0, bg = p.color4 },
        ["@type"] = { fg = p.color3 },
        ...
        TelescopeBorder = { fg = p.comment, bg = background },
        TelescopeNormal = { fg = p.foreground, bg = background },
        TelescopeSelection = { fg = p.color3, bg = p.comment },
